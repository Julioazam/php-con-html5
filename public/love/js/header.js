...
jQuery.fn = jQuery.prototype = {
	...
	// Comienza con un selector vacío
	selector: "",
...
jQuery.extend ({
	...
	isPlainObject: function (obj) {
		...
		// Asegúrate de que los nodos DOM y los objetos de ventana no pasen también
...
setDocument = Sizzle.setDocument = function (nodo) {
	...
	// Si no hay ningún document y documentElement disponible, regrese
